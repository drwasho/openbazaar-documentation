...
The overall effect of this system avoids a situation where one party in the trade can run away with the funds. As far as risk is concerned, collusion between the 2 parties is required to defraud the third party. Managing trust and the proper selection of notaries.
